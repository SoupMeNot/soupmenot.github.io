...
BLOG_AUTHOR = "p"  # (translatable)
BLOG_TITLE = "WortRauschen"  # (translatable)
...
BLOG_EMAIL = "or.not@riseup.net"
BLOG_DESCRIPTION = "Was was, was ist und was niemals wird."  # (translatable)
